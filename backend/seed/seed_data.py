...
def run_seed(db: Session) -> dict:
    ...
    demo_users = [
        ...
        User(id=str(uuid.uuid4()), name="Admin User", email="admin@railoptix.in", password=hash_password("RailAdmin@120"), role="admin", department=None, zonal_railway="Northern Railway"),
        User(id=str(uuid.uuid4()), name="Priya Sharma", email="engineer@railoptix.in", password=hash_password("RailEng@120"), role="dept_engineer", department="Engineering", zonal_railway="Northern Railway"),
        User(id=str(uuid.uuid4()), name="Rajesh Kumar", email="controller@railoptix.in", password=hash_password("RailControl@120"), role="section_controller", department=None, zonal_railway="Northern Railway"),
        User(id=str(uuid.uuid4()), name="Arjun Nair", email="traction@railoptix.in", password=hash_password("RailTrd@120"), role="dept_engineer", department="Traction Distribution", zonal_railway="Northern Railway"),
        User(id=str(uuid.uuid4()), name="Deepa Menon", email="st@railoptix.in", password=hash_password("RailSt@120"), role="dept_engineer", department="Signal & Telecom", zonal_railway="Northern Railway"),

        # Gov.in accounts with 123 password
        User(id=str(uuid.uuid4()), name="Admin Officer", email="admin@railoptix.gov.in", password=hash_password("Admin@123"), role="admin", department=None, zonal_railway="Northern Railway"),
        User(id=str(uuid.uuid4()), name="Section Controller Delhi", email="controller.delhi@railoptix.gov.in", password=hash_password("Controller@123"), role="section_controller", department=None, zonal_railway="Northern Railway"),
        User(id=str(uuid.uuid4()), name="Track Engineer", email="eng.track@railoptix.gov.in", password=hash_password("Engineer@123"), role="dept_engineer", department="Engineering", zonal_railway="Northern Railway"),
    ]
    added_users = 0
    for u in demo_users:
        ...
        for c in ALL_18_ZONE_CORRIDORS:
            ...
            for day_offset in range(7):
                ...
                for h in range(24):
                    ...
                    traffic_data_list.append(TrafficData(
                        section_id=c["section_id"],
                        date=d,
                        hour=h,
