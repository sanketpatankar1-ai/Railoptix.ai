"""
RailOptix — FastAPI Application Entry Point (v2.0)
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.info(f"[*] RailOptix v{settings.VERSION} — DB tables verified/created")
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=settings.CORS_ORIGINS + ["https://railoptix-ai-1.onrender.com", "http://localhost:3000", "http://localhost:5173"],
