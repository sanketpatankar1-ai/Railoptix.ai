# 🚆 RailOptix — AI-Powered Automatic Block Planning System
...
git clone https://github.com/subham120/RailOptix.git
cd RailOptix
...
RailOptix is production-ready for deployment on **Render**, **Railway**, or any standard **Linux/VPS Server**.
...
2. Connect your GitHub repository (`subham120/RailOptix`).
3. Set your `GEMINI_API_KEY` when prompted.
4. Click **"Apply"** — Render automatically provisions:
   - `railoptix-api` (FastAPI Python backend)
   - `railoptix-frontend` (React static site)
