/**
 * AssistantPage.jsx — RailOptix Intelligent Maintenance & Operations Advisor.
 * Features:
...
const STORAGE_KEY_MESSAGES = 'railoptix_assistant_messages';
const STORAGE_KEY_CONTEXT = 'railoptix_assistant_context';

const INITIAL_MESSAGE = {
  role: 'assistant',
  content: "Namaste! I am the **RailOptix Operations Advisor**.\n\n" +
...
export default function AssistantPage() {
  ...
  const exportChat = () => {
    ...
    a.href = url;
    a.download = `RailOptix_Briefing_${new Date().toISOString().slice(0, 10)}.txt`;
    a.click();
